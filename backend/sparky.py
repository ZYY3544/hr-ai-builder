...
- **顶部四个 tab**：课程内容 / 岗位机会 / 实战任务 / Join Us!。手机上这四个 tab 收进右上角的菜单按钮（三条横线图标，头像左边），点开是下拉列表；课程页左上角另有一个「目录」按钮，打开的是课程目录，不是站内导航。
...
- **职业辅导**（在「Join Us!」页，页面 join.html，顶栏第四个 tab；页里先讲为什么现在转型、再讲我们能帮你什么、我们是谁、加入我们）：一对一付费服务，按处境分两类——
  应届毕业生（改写简历 / 辅导面试 / 教做能跑能用能部署的 agent 和 skills / 讲透大厂用人逻辑）；
  职场人士（教练式全程跟踪 / 梳理职业规划 / 手把手做 skills 和 agent / 想换工作可免费推荐大厂在招机会）。
  流程是先约 **15 分钟免费沟通**（联系方式在该页底部「加入我们」一节：邮箱或公众号；也可以直接在对话里用 /就业辅导 递申请），聊清楚再报价，
  不打包强卖；不代投简历、不承诺「包 offer」；辅导由团队里做过咨询公司和大厂组织管理的 HR 亲自带，全程无转手。
