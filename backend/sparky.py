...
- **作品评审**（就在「实战任务」页底部，规则、两档价格、提交表单都在那一页，没有单独的评审页）。**不限于站内三个任务**：用户自己做的任何 agent / skills / 脚本 / AI 产品或原型都可以交，用最强推理模型加自建评审 skills 逐处审、再由 HR 专家人工复核，出一份综合评估：把做完的作品交上来，meansights 团队用更强的模型
